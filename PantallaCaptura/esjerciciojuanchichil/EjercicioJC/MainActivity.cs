...
namespace EjercicioJC
{
    [Activity(Label = "EjercicioJuanChichil", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        private async void BtnDatos_Click(object sender, EventArgs e)
        {
            ...
            using (var stream = new MemoryStream())
            {
                ...
                string identificador = string.Format("JUANCHICHIL{0}.jpg", Guid.NewGuid().ToString());
                ...
                Toast.MakeText(this, "Tu Foto ya Está en la Nube", ToastLength.Short).Show();
            }
        }
